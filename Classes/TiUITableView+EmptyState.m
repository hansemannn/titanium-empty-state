//
//  TiUITableView+EmptyState.m
//  titanium-empty-state
//
//  Created by Hans Knöchel on 01.04.18.
//

#import "TiUITableView+EmptyState.h"
#import "TiUIViewProxy.h"

@implementation TiUITableViewProxy (EmptyStateProxy)
...
- (void)setPlaceholder:(id)arguments
{
  ...
  if (tableView.emptyDataSetSource == nil && tableView.emptyDataSetDelegate == nil) {
    tableView.emptyDataSetSource = (TiUITableView *)self.view;
    tableView.emptyDataSetDelegate = (TiUITableView *)self.view;
  }
...
@implementation TiUITableView (EmptyState)
